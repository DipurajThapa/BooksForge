...
in the BooksForge community a harassment-free experience for everyone,
...
requests, discussions, the project's chat channels, and any in-person
events — and also applies when an individual is officially representing
the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may
be reported to the maintainers at **conduct@booksforge.app**
*(if this address is not yet provisioned, report via GitHub Security
Advisories — the same private channel used for security reports).*
...
*Refs: EXTERNAL_AUDIT_BACKLOG.md #6 (CODE_OF_CONDUCT.md missing).*
