...
export default function Binder({ nodes, selectedId, onSelect, onNodesChanged }: Props) {
  ...
  // Flat scene list — Binder currently renders a flat scene roll, not the
  // full nested tree. The roots/parts/chapters layer is reintroduced in
  // a later milestone; the binding stays so the import surface is stable.
