...
fn render_styles_xml(profile: FormatProfile) -> String {
    ...
    let indent_twips = (parse_em(profile.paragraph_indent_em()).unwrap_or(1.2) * body_pt * 20.0).round() as u32;
...
mod tests {
    ...
    fn build_produces_a_valid_zip_archive() {
        ...
        for name in [
            ...
            assert!(zip.by_name(name).is_ok(), "expected entry {name} in reference.docx");
        }
    }
    ...
    fn styles_xml_quotes_the_format_profile_fonts() {
        ...
        assert!(xml.contains(r#"w:ascii="Cormorant Garamond""#),
    ...
    fn body_size_round_trips_from_format_profile_pt_to_half_points() {
        ...
        assert!(xml.contains(r#"<w:sz w:val="21"/>"#),
    ...
    fn build_differs_for_different_profiles() {
        ...
        assert_ne!(a, b, "different profiles must produce different reference.docx");
    }
    ...
    fn drop_cap_style_emitted_when_profile_enables_drop_cap() {
        ...
        assert!(xml.contains(r#"w:styleId="Drop""#),
                "expected Drop paragraph style for drop-cap-enabled profile");
        assert!(xml.contains(r#"w:dropCap="drop""#),
    ...
    fn scene_break_style_emitted_for_profiles_with_a_glyph() {
        ...
        assert!(xml.contains(r#"w:styleId="SceneBreak""#),
    ...
    fn line_height_serialises_as_auto_multiple() {
        ...
        // 1.5 × 240 = 360.
        assert!(xml.contains(r#"w:line="360" w:lineRule="auto""#),
