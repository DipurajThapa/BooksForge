...
const FAILURE_MODES: &[FailureMode] = &[
    ...
    FailureMode { id: "axis-out-of-enum",    description: "Check axis not in the four T2 axes.",          recoverable: true  },
    FailureMode { id: "no-evidence",         description: "Check has no evidence string.",                recoverable: true  },
    FailureMode { id: "loops-back-to-self",  description: "Validator hallucinates that itself is wrong.", recoverable: false },
];
...
pub fn parse_and_validate(raw: &str) -> Result<ProposalValidation, String> {
    let parsed: ProposalValidation = serde_json::from_str(raw)
