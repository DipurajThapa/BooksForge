use booksforge_domain::{BookKind, BookMode, Project, ProjectMeta};
use chrono::Utc;
use ulid::Ulid;
...
pub fn fiction_project() -> Project {
    ...
    Project {
        ...
        // Phase 4 of PRODUCT_ROADMAP_E2E.md — fixture defaults to
        // LiteraryFiction. Tests that need GenreFiction or Memoir
        // routing override this field after calling the fixture.
...
mod schema_drift {
    ...
    fn fixture_has_realistic_required_fields() {
        ...
        assert!(
            p.meta.target_words.is_some(),
            "target_words exercised by export tests"
        );
