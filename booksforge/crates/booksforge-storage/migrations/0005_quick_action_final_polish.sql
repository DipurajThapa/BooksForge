-- Migration v5 — extend `ai_calls.preset` CHECK to allow `final_polish`.
--
-- Quick-action presets gain a fourth variant: `FinalPolish`, the high-end
-- editor pass model-pinned to qwen3.6.  SQLite cannot ALTER a CHECK in
-- place, so rebuild the table preserving existing rows.
