...
mod tests {
    ...
    fn preset_template_mapping_is_pinned() {
        assert_eq!(QuickActionPreset::Sharpen.template(),     ("sharpen-prose",      "v1"));
        assert_eq!(QuickActionPreset::Continue_.template(),   ("continue-paragraph", "v1"));
        assert_eq!(QuickActionPreset::Rephrase.template(),    ("rephrase",           "v1"));
        assert_eq!(QuickActionPreset::FinalPolish.template(), ("final-polish",       "v1"));
    ...
    fn final_polish_is_model_pinned() {
        assert_eq!(QuickActionPreset::FinalPolish.pinned_model(), Some("qwen3.6:latest"));
    ...
    #[test]
    fn status_roundtrip() {
        for s in [AiCallStatus::Ok, AiCallStatus::Cancelled, AiCallStatus::Error] {
